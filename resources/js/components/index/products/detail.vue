<template>
  <div>
    <h1>{{ product["title"] }}</h1>
    <p>
      В продаже {{ product["title"] }} оптом и в розницу. Нашли дешевле? Предоставьте свою цену, Мы сформируем более выгодное предложение. При заказе от 3000р., доставка по Самаре - БЕСПЛАТНО! Возможна отправка товара в любую точку РФ транспортной компанией.
    </p>
